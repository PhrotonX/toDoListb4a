...
Public Sub GetSnoozeFromText(value As String, Lang As LanguageManager) As Long
	Select value
		Case Lang.Get("off"):
			Return SNOOZE_OFF
		Case Lang.Get("1_minute"):
			Return SNOOZE_1_MINUTE
		Case Lang.Get("3_minutes"):
			Return SNOOZE_3_MINUTES
		Case Lang.Get("5_minutes"):
			Return SNOOZE_5_MINUTES
		Case Lang.Get("10_minutes"):
			Return SNOOZE_10_MINUTES
		Case Lang.Get("15_minutes"):
			Return SNOOZE_15_MINUTES
		Case Lang.Get("20_minutes"):
			Return SNOOZE_20_MINUTES
		Case Lang.Get("30_minutes"):
			Return SNOOZE_30_MINUTES
		Case Lang.Get("1_hour"):
			Return SNOOZE_1_HOUR
		Case Lang.Get("2_hours"):
			Return SNOOZE_2_HOURS
		Case Lang.Get("5_hours"):
			Return SNOOZE_5_HOURS
		Case Lang.Get("12_hours"):
